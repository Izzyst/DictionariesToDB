...
namespace ConsoleApp1.Factories
{
    public class EnglishWordsFactory : AbstractDictionary
    {
        ...
        public List<String> GetLinks()
        {
            ...
            {
                html = "https://www.collinsdictionary.com" + item.Attributes["href"].Value;// letters A-Z
                subwords = GetRandomLinksFromPage(html, 5, "//ul[@class='columns2 browse-list']/li/a", "https://www.collinsdictionary.com");// zwraca liste słów zawierającą się w danym przedziale literowym np. ab..., abg...., ath...
                ...
                else// ponieważ słowa w przedziale # nie posiadają podprzedzialów, dlatego je omijam
                {
                    ...
                    {
                        w = GetRandomLinksFromPage(sub, 1, "//ul[@class='columns2 browse-list']/li/a", "https://www.collinsdictionary.com");
                        lock (links)
                        {
